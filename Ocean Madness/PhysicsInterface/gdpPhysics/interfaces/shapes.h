...
namespace gdpPhysics
{
	...
	{
	public:
		CapsuleShape(const glm::vec3& halfExtents);
	...
	private:
		...
		CapsuleShape(const CapsuleShape&) : iShape(ShapeTypeCylinder) {}
		CapsuleShape& operator=(const CapsuleShape&) { return *this; }
	};
	...
	public:
		...
		const glm::vec3& GetInformation() const { return information; }
	...
	private:
		...
		ConeShape(const CylinderShape&) : iShape(ShapeTypeCylinder) {}
